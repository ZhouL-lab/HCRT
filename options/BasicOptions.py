...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/media/dell/SATA1/HCRT/checkpoints',
        ...
        parser.add_argument('--datapath', default='/media/dell/D/breastTumorSeg/YN', help='path of the PET raw data')
        parser.add_argument('--lr', type=float, default=0.0012, help='initial learning rate of net for adam')  # 0.005
        ...
        parser.add_argument('--patch_size', type=int, default=(48, 128, 128), help='the size of crop patch')
        ...
        parser.add_argument('--task_name', type=str, default='HCRT', help='the current task name')
